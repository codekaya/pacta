...
export function SubmitButton({ children, pendingLabel, variant = 'primary' }: Props) {
  ...
  const base =
    'inline-flex min-h-11 w-full items-center justify-center px-5 text-[15px] tracking-wide transition-colors duration-150 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ink disabled:cursor-not-allowed disabled:opacity-55';
  const skin =
    variant === 'primary'
